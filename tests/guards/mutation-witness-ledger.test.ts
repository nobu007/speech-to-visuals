...
/** Ledger entries shipped with Phase 141 (6) + Phase 142 (MW-007) + Phase 143 (MW-008) + Phase 144 (MW-009). Increases are fine; decreases fail. */
const PINNED_MIN_ENTRIES = 9;
