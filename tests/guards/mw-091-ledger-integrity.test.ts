...
describe('MW-091 ledger integrity (PR #75 follow-up)', () => {
  ...
  it('parent guard (mutation-witness-ledger.test.ts) keeps PINNED_MIN_ENTRIES = 87 (MW-092 floor bump + MW-093 REQ-420 recovery)', () => {
    ...
    expect(guardSrc).toMatch(/const PINNED_MIN_ENTRIES = 87;/);
