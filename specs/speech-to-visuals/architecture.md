...
**信頼性**: 🔵 *tests/guards/frozen-literal-rules.ts（round 25 時点 24 エントリ・743 行。round 24 は 23 エントリ・692 行、方針確立時 round 16 は 16 エントリ・423 行。round 25 は新 family 1 件: quality-gate threshold bars at consumer sites）・frozen-literal-registry.test.ts より*
