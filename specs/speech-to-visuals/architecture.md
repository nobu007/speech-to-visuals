...
**信頼性**: 🔵 *tests/guards/frozen-literal-rules.ts（round 23 時点 22 エントリ・644 行。round 22 は 21 エントリ・607 行、方針確立時 round 16 は 16 エントリ・423 行。round 23 は新 family 1 件: unicode script ranges）・frozen-literal-registry.test.ts より*
