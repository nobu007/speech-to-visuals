...
**信頼性**: 🔵 *tests/guards/frozen-literal-rules.ts（round 28 時点 27 エントリ・845 行。round 27 は 26 エントリ・810 行、round 26 は 25 エントリ・779 行、方針確立時 round 16 は 16 エントリ・423 行。round 28 は新 family 1 件: export block gate。次回再検討閾値は 1200 行（round 27 設定・未到達））・frozen-literal-registry.test.ts より*
