...
- [ ] **TC-056-01**: コールドスタート検出とウォームアップ実行 🔵
  - **条件**: キャッシュエントリ数 < 閾値
...
- [ ] **TC-053-01**: Standard モードでファイル処理 🔵
  - **期待結果**: ファイルアップロード→文字起こし→分析→動画生成が完了
  - **信頼性**: 🔵 *Index.tsx より*

- [ ] **TC-053-02**: Streaming モードでリアルタイム処理 🔵
