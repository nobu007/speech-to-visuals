...
**Common Libraries:** All generated scripts should use Miyabi's common libraries for environment setup:
...
This ensures consistent environment variable loading and Python path management across all skills, regardless of repository structure.
